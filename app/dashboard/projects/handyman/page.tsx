...
export default function Page() {
    ...
    <div className="mt-0 flex grow flex-col gap-4 md:flex-row">
      <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-10">
        <h1 className={`${lusitana.className} text-xl text-gray-800 md:text-3xl md:leading-normal`}><strong>NG Handyman</strong></h1>
        <p className={`${lusitana.className} text-xl text-gray-800 md:text-2xl md:leading-normal`}>
          Lorem ipsum dolor sit amet consectetur adipisicing elit.
        </p>
        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quisquam soluta, dolorem repellendus magnam inventore ducimus dolores a commodi itaque excepturi hic sunt? Dolores deserunt est praesentium repudiandae nemo accusamus eum!</p>
